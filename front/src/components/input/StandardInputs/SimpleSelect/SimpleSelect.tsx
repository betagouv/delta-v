...
export const SimpleSelect: React.FC<SimpleSelectOptions> = ({
  ...
  let className = `bg-white relative border border-secondary-300 border-solid rounded-full pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-primary-600 focus:border-primary-600 text-base`;
