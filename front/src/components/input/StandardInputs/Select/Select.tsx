        ...
        <>
          <div className="relative mt-1 flex-col">
            <Listbox.Button
              ...
              className={twMerge(
                classNames({
                  'bg-white relative rounded-full pl-3 pr-10 py-2.5 text-left text-sm md:text-xs focus:outline-none w-auto border-0 focus:ring-0':
                    true,
                  'w-full': fullWidth,
                    ...
                    {({ selected: selectedValue, active }) => (
                      <span
                        className={classNames(
                          ...
                          'block truncate text-base md:text-xs',
                          active ? 'bg-lightBlue' : '',
                        )}
                      >
                        {option.value}
