      ...
      <Modal open={open} onClose={onClose} withMargin={false}>
        <div className="my-3 flex flex-col items-center">
          <div className="flex flex-col items-center gap-0.5 justify-center">
            ...
            <Typography size="text-base" color="black" weight="bold">
              {declarationId}
            </Typography>
          </div>
          <div className="mt-5">
            <Typography size="text-sm" color="secondary" textPosition="text-center" tag="p">
          ...
          <div className="flex flex-1 flex-col items-center mt-4 gap-4">
            <Button onClick={onPaid} disabled={isLoading} className={{ 'w-[190px]': true }}>
              <Typography color="white">Déclaration payée</Typography>
            </Button>
            <Typography
              size="text-sm"
              color="primary"
