...
export const TobaccoBorder: React.FC = () => (
  <div className="flex flex-col md:text-xs">
    <div className="flex flex-row justify-around">
      <div className="flex flex-col items-center text-center">
        ...
        <span className="font-bold">40 unités</span>
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className="ml-7">
          <span className="font-bold">20 unités</span>
    ...
    <div className="flex flex-row justify-around">
      <div className="flex flex-col items-center text-center">
        ...
        <div className="ml-7">
          <span className="font-bold">10 unités</span>
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className="ml-8">
          <span className="font-bold">50 grammes</span>
