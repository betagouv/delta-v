...
export const TobaccoNonEu: React.FC = () => (
  <div className="flex flex-col">
    <div className="flex flex-row justify-around">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className="ml-7">
          <span className="font-bold">100 unités</span>
    ...
    <div className="flex flex-row justify-around">
      <div className="flex flex-col items-center text-center">
        ...
        <div className="ml-7">
          <span className="font-bold">50 unités</span>
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className="ml-8">
          <span className="font-bold">250 grammes</span>
