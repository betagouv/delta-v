...
export const AutocompleteInput = ({
  ...
  const error = getInputError(labelError, hideNoMatchError ? undefined : valueError) || (isSelectionDisabled && disabledItemSubmitError) || undefined;

  const Group = horizontal ? InputGroupHorizontal : InputGroup;

  const getMatchingResult = (searchValue: string) => {
  ...
  return (
    <Group id={labelId} required={required} label={label} helperText={helperText} error={error} center tooltipMessage={tooltipMessage} preventFocusOnLabelClick>
