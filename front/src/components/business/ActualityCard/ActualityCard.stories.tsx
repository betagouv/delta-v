...
export const ActualityCardComponent = () => (
  <div>
    <ActualityCard
      title={ACTUALITYCARD_DATA.title}
      creationDate={ACTUALITYCARD_DATA.creationDate}
      content={ACTUALITYCARD_DATA.content}
    />
  </div>
);
